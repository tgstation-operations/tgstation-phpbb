...
$lang = array_merge(
	$lang, array(
		'TFA_REQUIRED_KEY_MISSING'      => 'The administrator of this forum requires that you have added a Two Factor Authentication key for access to (limited) parts of this forum, however you currently have no (compatible) keys registerted to your account. You can add a new security key %s here%s.
												<br />For security reasons, access to the board has been disabled until you add a security key to your account. You might be required to fill in your password while adding a security key!
		...
		'TFA_OTP_KEY_LOG_EXPLAIN'			=> 'Please enter your security code from the two factor authentication app.',
		...
		'TFA_OTP'					=> 'OTP',
		'TFA_U2F'					=> 'U2F',
		'TFA_WEBAUTHN'				=> 'U2F (webauthn-testing)',
