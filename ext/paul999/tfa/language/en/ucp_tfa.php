...
$lang = array_merge(
	$lang, array(
		...
		'TFA_ADD_OTP_KEY_EXPLAIN'	=> 'Scan the QR code below with a Authenticator app (Like Google Authenticator or Authy), After that, confirm by providing a key from your Authenticator app. If you can not scan QR codes, you may manually enter the secret: %s.',
		'TFA_OTP_KEY'				=> 'OTP key',
		'TFA_OTP_INVALID_KEY'		=> 'Invalid key provided.',
		'TFA_KEYTYPE'				=> 'Key type',
		'TFA_KEY_NOT_USED'			=> 'Not used yet',
		'TFA_KEY'                   => 'Backup key',
		'TFA_BACKUP_KEY_EXPLAIN'	=> 'Below are backup keys, generated for in case you lose you keys or your key doesn’t
